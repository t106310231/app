...
//        mEmptyList = (TextView) findViewById(R.id.empty);
        ...
        devicelist2 = new ArrayList<String>();

        deviceAdapter = new ArrayAdapter<>(DeviceListActivity.this, android.R.layout.simple_list_item_1, devicelist2);
                        ...
                        public void run() {
                            if(!deviceList.contains(device)){
                                if(device.getName()!=null){
                                    ...
                                    devicelist2.add(device.getName()+"\n"+"rssi="+rssi);
...
//        if(serviceUUID != null && serviceUUID.equals(com.example.specsdc.SpectrumTransferService.SPECTRUM_TRANSFER_SERVICE_UUID)) {
